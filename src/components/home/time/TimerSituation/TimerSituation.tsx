...
export default function TimerSituation({
  ...
  return (
    <div className='w-full max-w-3xl text-center text-h_gray text-4xl flex flex-col items-center gap-4'>
      <h3 className='bg-h_light_black p-4 rounded-full w-full'>{`현재 ${subject}에 ${timer}초(원) 사용하셨습니다.`}</h3>
