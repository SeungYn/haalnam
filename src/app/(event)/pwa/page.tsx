	...
	return (
		<>
			...
			<section className="mx-auto my-10 w-full max-w-7xl">
				<section id="cpc" className="rounded-lg bg-h_light_black p-4">
					<h1 className="text-3xl font-bold">Chrome 앱 PC 설치 방법 </h1>
					<hr />
				</section>
				<section id="cand" className="bg-h_light_black">
					<h1>Chrome 앱 안드로이드 설치 방법 </h1>
					<hr />
				</section>
				<section id="cios" className="bg-h_light_black">
					<h1>Chrome 앱 IOS 설치 방법 </h1>
					<hr />
				</section>
				<section id="spc" className="bg-h_light_black">
					<h1>Safari 앱 PC 설치 방법 </h1>
					<hr />
				</section>
				<section id="sios" className="bg-h_light_black">
